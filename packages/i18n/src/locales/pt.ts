...
export const PT_MESSAGES: LocaleTexts = {
  ...
  help: {
    ...
    optInitTitle: "Inicialização do Plopfile",
    optGenerateTitle: "Gerar arquivos de Locale, Texts, Theme",
    optOthersTitle: "Outras opções",
    ...
    optPath: "Diretório de saída base para os arquivos de modelo gerados",
    optExtension: "Extensão de arquivo gerada: ts | js | json",
    optIncludeCustomTexts:
      "Para a geração de locale, incluir as chaves traduzíveis do plopfile",
